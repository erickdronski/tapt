-- 0049: beer_detail resolves style science via tapt_ref_style_name (messy OFF
-- styles like 'Pale Ales' -> real BJCP entries), always prefers the cutout,
-- cleans the display name. Every beer page gets real substance; nothing invented.
