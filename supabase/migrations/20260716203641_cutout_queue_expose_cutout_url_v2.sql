-- The pipeline filters candidates on cutout_url; recreate the view to expose it
-- (CREATE OR REPLACE cannot insert a column mid-list). Mirrors prod 2026-07-16.
drop view if exists public.cutout_queue;
create view public.cutout_queue as
select b.id, b.name, b.label_image_url, b.label_image_license, b.cutout_url,
       b.updated_at, s.standing as market_standing
